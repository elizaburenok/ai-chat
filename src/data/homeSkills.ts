...
export const homeSkills: SkillItem[] = [
  ...
  { id: 'tariffs', title: 'Тарифы', themeId: 'client-attitude', priority: 'not_evaluated', iconBgColor: 'var(--color-bg-neutral-2)' },
  { id: 'ved-2', title: 'Валютный контроль', themeId: 'knowledge', priority: 'not_evaluated', iconBgColor: 'var(--color-bg-neutral-2)' },
